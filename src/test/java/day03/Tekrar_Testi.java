   ...
   /*
     ...
     */
        public static void main(String[] args) {
            ...
            //b. Search(ara) “city bike”
            WebElement aramaKutusu = driver.findElement(By.id("twotabsearchtextbox")); //Arama kutusuna gider
            aramaKutusu.sendKeys("city bike", Keys.ENTER);   //Arama kutusuna istenen aranacak kelimeyi yazdırır
